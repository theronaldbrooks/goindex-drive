...
function nav(path) {
    ...
    <a href="https://github.com/theronaldbrooks/goindex-drive" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'GoIndex Drive on Github'}">
